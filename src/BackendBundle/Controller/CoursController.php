...
class CoursController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $cours = $em->getRepository('BackendBundle:Cours')->findAll();
    ...
    {
        $cour = new Cour();
        $form = $this->createForm('BackendBundle\Form\CoursType', $cour);
    ...
    {
        $deleteForm = $this->createDeleteForm($cour);
        $editForm = $this->createForm('BackendBundle\Form\CoursType', $cour);
