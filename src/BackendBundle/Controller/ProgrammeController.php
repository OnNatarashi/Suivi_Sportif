...
use BackendBundle\Entity\Programme;
...
class ProgrammeController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $programmes = $em->getRepository('BackendBundle:Programme')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('BackendBundle\Form\ProgrammeType', $programme);
    ...
    {
        $deleteForm = $this->createDeleteForm($programme);
        $editForm = $this->createForm('BackendBundle\Form\ProgrammeType', $programme);
